...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/bus-theme.css">
</head>
<body>
    <div class="wrapper">
        <div class="topbar">
            ...
            <div class="controls" style="gap:8px; flex-wrap: wrap;">
                <a class="button" href="/">Trajets</a>
                <a class="button" href="/benefice_par_jour">Bénéfice / jour</a>
                <a class="button" href="/trajets_rentables">Trajets rentables</a>
            </div>
        </div>
        ...
        <div class="card hero">
            ...
            <form class="controls" method="get" data-filter-form>
                ...
                <a class="button" href="/voitures_disponibles" style="text-decoration:none;">Réinitialiser</a>
            </form>
        </div>
